!(function () {
        ...
        function n(e, t) {
            ...
            n.classList.remove("tb"),
                ...
                i
                    ...
                    : "next" === t
                    ? (e.firstElementChild.classList.add("tb"), e.parentNode.getElementsByClassName("ne")[0].firstElementChild.classList.add("tb"))
                    : (e.lastElementChild.classList.add("tb"), e.parentNode.getElementsByClassName("ne")[0].lastElementChild.classList.add("tb"));
        }

        function i(e, t) {
            let n,
                i = 0;
            for (let e = 0; e < t.length; e++) (t[0].parentNode.style.minHeight = i + "px"), t[e].classList.add("w"), (n = t[e].offsetHeight), t[e].classList.remove("w"), n > i && (i = n);
        ...
        if (t.length > 0)
            for (let a = 0; a < t.length; a++) {
                ...
                for (let e = 0; e < c.length; e++) {
                    c[e].setAttribute("data-carousel", e), c[e].classList.contains("tb") && (r = e);
                    let t = document.createElement("tbuttonn");
                    (t.className = "nt"), t.setAttribute("data-bullet", e), l.parentNode.getElementsByClassName("ne")[0].appendChild(t);
                }
    ...
    (function () {
        ...
        e &&
            ...
            document.addEventListener("click", function (n) {
                n.target === t || n.target === e || t.contains(n.target) || (document.body.classList.remove("tv"), t.classList.remove("tb"), (t.style.maxHeight = null), e.setAttribute("aria-expanded", "false"));
            }));
    })(),
    (function () {
        "use strict";
            ...
            for (let e = 0; e < t.length; e++) {
                ...
                i &&
                    ...
                    n.addEventListener("click", function (e) {
                        var t;
                        e.preventDefault(), n.hasAttribute("aria-controls") && (t = i) && (document.body.classList.add("modal-is-active"), t.classList.add("tb"));
                    }));
            }
        document.addEventListener("click", function (e) {
            (e.target.classList.contains("tx") || e.target.classList.contains("modal-close-trigger")) && (e.preventDefault(), n());
        }),
    ...
    (function () {
        ...
        if (e.length > 0)
            for (let n = 0; n < e.length; n++) {
                ...
                (s.data = JSON.parse(s.el.getAttribute("data-price-input"))), (s.currentValEl = i.querySelector(".it")), (s.thumbSize = parseInt(window.getComputedStyle(s.currentValEl).getPropertyValue("--thumb-size"), 10));
    ...
    (function () {
        ...
        e.length > 0 && document.body.classList.contains("t") && (window.addEventListener("load", i), window.addEventListener("scroll", s), window.addEventListener("resize", a));
    })(),
    (function () {
        "use strict";
    ...
    (function () {
        ...
        function t(e) {
            ...
            document.getElementById(t).classList.add("tb"), e.classList.add("tb");
        }
        if (e.length > 0)
            for (let n = 0; n < e.length; n++) {
                let i = e[n];
                i.addEventListener("click", function (n) {
                    ...
                    if (!this.classList.contains("tb")) {
                        for (let t = 0; t < e.length; t++) e[t].classList.remove("tb");
                        for (let e = 0; e < i.length; e++) i[e].classList.remove("tb");
                        t(this);
                    }
                }),
